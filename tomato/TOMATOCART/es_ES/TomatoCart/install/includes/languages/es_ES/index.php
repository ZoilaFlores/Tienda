...
page_title_welcome = Bienvenido  a TomatoCart V1.0.1
...
text_welcome = <p style="background-color: #ff6633; padding: 5px; border: 1px #000 solid;">Tenga en cuenta que se trata de una versión de desarrollo alfa unsuppported que no se va a utilizar para uso en producción.</p><p>TomatoCart es la nueva generación abierta fuente de compras solución del carro desarrollada por Elootec, sino que se ramifica a partir de osCommerce 3 alfa 4 "Lebkuchen", como un proyecto independiente. Su característica embalada fuera de la caja de la instalación permite a los propietarios de las tiendas para configurar, ejecutar y mantener sus tiendas en línea con el mínimo esfuerzo y sin costes.</p><p>TomatoCart combina soluciones de código abierto para proporcionar una plataforma de desarrollo libre y abierto, que incluye el <i>poderoso</i> PHP lenguaje de scripting web, el <i>estable</i> El servidor web Apache, y el <i>rápido</i> MySQL base de datos.</p><p>Sin restricciones o requisitos especiales, TomatoCart se puede instalar en cualquier servidor web habilitado para PHP4 o PHP5, en cualquier entorno que soporte PHP y MySQL, que incluye Solaris Linux, BSD, y entornos de Microsoft Windows.</p>
