...
heading_title = Estados de Pedido
...
table_heading_public_flag = Estado público
table_heading_downloads_flag = Estado de descarga
table_heading_returns_flag = Estado de devolución
table_heading_gift_certificates_flag = Estado de los Cupones de Descuento
table_heading_action = Acción

field_name = Nombre:
field_set_as_default = ¿Fijar como Predeterminado?
field_public_flag = Estado público:
field_downloads_flag = Estado de la descarga:
field_returns_flag = Estado de devolución:
field_gift_certificates_flag = Estado de los Cupones de descuento:
