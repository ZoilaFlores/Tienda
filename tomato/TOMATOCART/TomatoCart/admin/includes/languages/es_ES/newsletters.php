...
newsletter_customer = Clientes
newsletter_product_notifications_table_heading_products = Productos
newsletter_product_notifications_table_heading_selected_products = Productos Seleccionados
...
newsletter_product_notifications_button_clear = vaciar
newsletter_select_customers = debe seleccionar un cliente
...
ms_error_action_not_email = No hay dirección de email.

ms_success_action_email = El Envio del email de prueba a sido satisfactorio.

introduction_test_emails = Enviar Email de prueba:

icon_test_email = Prueba Enviar E-Mail
