...
table_heading_tax_classes = Tipod de Impuestos
...
section_tax_rates = Tipos Impositivos
...
introduction_new_tax_class = Por favor complete la información siguiente para el nuevo tipo de impuesto.

introduction_edit_tax_class = Por favor realize los cambios necesarios para este tipo de impuesto.

introduction_delete_tax_class = Por favor verifique el retiro de este impuesto y sus entradas de porcentajes.
...
introduction_batch_delete_tax_classes = Por favor verifique el retiro de estos impuestos y sus entradas de porcentajes.
