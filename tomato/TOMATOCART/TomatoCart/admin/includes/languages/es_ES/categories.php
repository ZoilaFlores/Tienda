...
tree_root_title = Raiz

operation_title_search = Buscar:

section_general = General
section_meta = Info Motores Busqueda:
section_ratings = Puntuación

table_heading_categories = Categorías
table_heading_status = Estado
table_heading_action = Acción
table_heading_ratings = Nombre puntuación
...
field_products_extra_fields_group = Productos, Campos Grupo Extra:
field_name = Nombre:
field_url = Url amigable:
field_image = Imagen:
field_sort_order = Orden:
field_status = Estado:
status_enabled = Habilitado
status_disabled = Inhabilitado

field_page_title = Título Página:
field_meta_keywords = Palabras clave:
field_meta_description = Descripción:



none = -- Vacio --
top_category = -- Principal --
