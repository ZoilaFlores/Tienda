...
panel_graphs_title = Gráficos
panel_table_title = Tabla
banner_manager_new_dialog = Nuevo
banner_manager_edit_dialog = Editar
banner_manager_preview_dialog = Previsualizar
banner_manager_statistics_dialog = Estadísticas

action_heading_new_banner = Nuevo Banner
...
operation_heading_type_value = Diario
...
field_title = Título:
field_url = Direccion WEB:
field_group = Grupo:
field_banner_type = Tipo Banner
field_image = Imagen:
field_html = Texto HTML
...
info_banner_fields = <b>Notas Del Banner:</b><ul><li>Use una imagen o texto HTML para el banner - No ambas.</li><li>El texto HTML tiene prioridad sobre una imagen.</li></ul>
...
ms_error_date_scheduled_empty = Error: Por favor, especifique la fecha prevista.<br />
ms_error_date_expires_empty = Error: Por favor, especifique la fecha de expiración.<br />
ms_error_banners_title_empty = Error: Por favor, rellene un título banners. <br />
ms_error_banners_title_double = Error: El título no puede repetirse. <br />
ms_error_banners_image_double = Error: El archivo ya existe. <br />
ms_error_banners_url_empty = Error: Por favor, rellene la direccion URL (http://...) del banner. <br />
ms_error_group_empty = Error: Por favor, rellene un grupo. <br />
ms_error_group_style = Error: El estilo del grupo debe ser  X*Y . por ejemplo: 200*300 <br />
